                ...
                <div
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="-space-y-1">
                            ...
                            <span className="inline-block text-xs leading-none dark:text-gray-600">Sponcored</span>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            <button onClick={()=> setUserRating(!userRating)} type="button" title="Like post" className={`flex items-center justify-center  `}  >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={`w-5 h-5 fill-current rounded-full ${userRating ? 'bg-blue-800' : 'bg-white'}`}>
                    ...
                    <div
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm">Liked by
                                <span className="font-semibold">Imran Hassan</span>and
