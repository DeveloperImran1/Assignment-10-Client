            ...
            <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-white  dark:bg-gray-50 dark:text-gray-800 border">
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">{member[0] || "Leroy Jenkins"}</h2>
                        <p className="px-5 text-xs sm:text-base dark:text-gray-600">{member[1] || "Full-stack developer" }</p>
                    </div>
